...
<body>
  <div class="container my-5">
    <h1>Projects</h1>
    <a href="projects/create" class="btn btn-primary mb-3">Add Project</a>
      ...
      <?php foreach ($projects as $project): ?>
        <dt class="list-group-item">
          ...
          <div class="d-flex flex-column align-items-start">
            <!-- More Info Button -->
            <a href="projects/<?= $project->id ?>" class="btn btn-info btn-sm mb-2" title="More Info">
              More Info
            </a>

            <!-- Edit Button -->
            <a href="projects/<?= $project->id ?>/edit" class="btn btn-warning btn-sm mb-2" title="Edit">
              Edit
            </a>
